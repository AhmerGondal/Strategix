          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                  With over 10 years of experience in the tax advisory sector,
                  we offer a rigid and attenuating counsel that serves to
                  empower our consumer base.{" "}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                  We offer long term financial consulting strategies backed by a
                  pivotal background in money management and business
                  enterprise.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                  Personalized one-on-one meetings with experienced tax and
                  finance professionals with accredited backgrounds and years of
                  tenured experience.
                </p>
              </div>
            </div>
        ...
        <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
          ...
          >
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <div>
                <p className="my-3 text-xl text-gray-600 font-semibold">
                  ...
                  deep understanding of the latest financial trends and
            ...
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <div>
                <p className="my-3 text-xl text-gray-600 font-semibold">
                  We can collaborate with your existing teams to scale existing
                  software applications or design customized financial solutions
                  that suits your everyday need and simplifies various
                  processes.
                </p>
              </div>
            </div>
